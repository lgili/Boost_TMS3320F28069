...
void ADC(void)
{
	...
	extern void DSP28x_usDelay(Uint32 Count);
		...
		AdcRegs.ADCSOC2CTL.bit.CHSEL 	= 1;    // set SOC1 channel select to ADCINA1
		...
		AdcRegs.ADCSOC1CTL.bit.CHSEL 	= 0x8;    // set SOC2 channel select to ADCINB0
		...
		AdcRegs.ADCSOC3CTL.bit.CHSEL 	= 0xA;    // set SOC3 channel select to ADCINB2
